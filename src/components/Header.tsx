  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur border-b border-slate-200/60 dark:border-slate-800/60 bg-white/65 dark:bg-slate-950/50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <a href="#" className="font-semibold tracking-tight text-slate-800 dark:text-slate-100">Laith M. alkhalil-AlHamed<span className="text-brand"></span></a>
        <nav className="hidden md:flex gap-6 text-sm text-slate-600 dark:text-slate-300">
          ...
          {/*<a href="/resume.pdf" className="hover:text-brand" target="_blank" rel="noopener">Resume</a>*/}
        </nav>
